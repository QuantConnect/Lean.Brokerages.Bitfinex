...
{
    [TestFixture]
    public class BitfinexExchangeInfoDownloaderTests
    {
        [Test]
        public void GetsExchangeInfo()
        {
            var eid = Composer.Instance.GetExportedValueByTypeName<IExchangeInfoDownloader>("BitfinexExchangeInfoDownloader");
